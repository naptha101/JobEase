...
const idHAsh=await bcrypt.hash(expert.id,10);
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: 'http://localhost:5173/success/expert/'+expert.id, // Redirect URL after successful payment
      cancel_url: 'http://localhost:5173/cancel/expert', // Redirect URL after canceled payment
    });
